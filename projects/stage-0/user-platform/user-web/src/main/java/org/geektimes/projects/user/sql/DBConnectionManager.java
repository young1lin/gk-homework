...
//
        ...
        Thread.sleep(1000);
        Connection connection  = DriverManager.getConnection("jdbc:derby://localhost/db/user-platform;create=true");
        // String databaseURL = "jdbc:derby://localhost/db/user-platform;create=true";
