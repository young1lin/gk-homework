...
class KeyValueTypePair {
    ...
    public static org.geektimes.cache.KeyValueTypePair resolve(Class<?> targetClass) {
        ...
        org.geektimes.cache.KeyValueTypePair pair = null;
    ...
    private static org.geektimes.cache.KeyValueTypePair resolveFromInterfaces(Class<?> type) {
        org.geektimes.cache.KeyValueTypePair pair = null;
    ...
    private static org.geektimes.cache.KeyValueTypePair resolveFromType(Type type) {
        org.geektimes.cache.KeyValueTypePair pair = null;
            ...
            if (pType.getRawType() instanceof Class) {
                ...
                if (arguments.length == 2) {
                    ...
                    if (keyType != null && valueType != null) {
                        pair = new org.geektimes.cache.KeyValueTypePair(keyType, valueType);
                    }
                }
            }
        }
